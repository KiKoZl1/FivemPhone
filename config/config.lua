...
Config.Companies.Services = {
    ...
    {
        job = "unternehmen_12",
        name = "Wuppel AbschleppBergedienst",
        icon = "https://cdn-icons-png.flaticon.com/128/12916/12916904.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the companyvector3(38.750, 6452.316, 31.425)
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    {
        job = "unternehmen_10",
        name = "Lightning-Transport Logistics",
        icon = "https://cdn-icons-png.flaticon.com/128/2821/2821904.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the companyvector3(38.750, 6452.316, 31.425)
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    {
        job = "unternehmen_11",
        name = "May Fair Nightclub",
        icon = "https://cdn-icons-png.flaticon.com/128/8729/8729269.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the companyvector3(38.750, 6452.316, 31.425)
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    {
        job = "realestateagent",
        name = "Immobilien Markler",
        icon = "https://cdn-icons-png.flaticon.com/128/9872/9872673.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the companyvector3(38.750, 6452.316, 31.425)
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
...
Config.DateLocale = "es-HN" -- https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat/DateTimeFormat
...
Config.CityName = "Calyx" -- The name that's being used in the weather app etc.
